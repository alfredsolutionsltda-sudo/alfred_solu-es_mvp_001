...
export default function ProfilePage({ profile }: ProfilePageProps) {
  ...
  return (
    <main className="min-h-screen bg-surface pt-10 pb-16 px-6 lg:px-10 max-w-[1600px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-8 xl:col-span-9 space-y-8">
          ...
          {/* Navegação por Abas */}
          <div className="bg-surface-container-lowest p-2 rounded-2xl shadow-premium inline-flex items-center gap-1">
            {tabs.map((tab) => (
              <button
                key={tab.id}
